...
export const PANEL_CATEGORY = document.getElementById(ID_CATEGORY);
export const PANEL_PLAYGROUND = document.getElementById(ID_PLAYGROUND);
export const PANEL_INVENTORY = document.getElementById(ID_INVENTORY);
export const PANEL_INBOX = document.getElementById(ID_INBOX);
...
export const DRAG_GROUP_SELECT_AUDIO = "assets/audio/common/drag_figure.mp3";
export const DROP_GROUP_SELECT_AUDIO = "assets/audio/common/drop_figure.mp3";
export const CANCEL_GROUP_SELECT_AUDIO = "assets/audio/common/click_figure.mp3";
