import { getPlaygroundFigures, removePlaygroundFigureBySerial, } from "../../services/gameStateService.js";
...
export class PlaygroundManager {
    constructor() {
        ...
        if (!el)
            throw new Error("#playground 컨테이너가 존재하지 않습니다.");
        this.container = el;
        this.render(); // 최초 1회
    ...
    render() {
        const figures = getPlaygroundFigures().slice();
        renderPlayground((serial) => {
            // 우클릭 삭제 시 콜백
