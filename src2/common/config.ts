...
export const ID_INVENTORY_GROUP = "inventory-group";
export const ID_CATEGORY_GROUP = "catalog-group";
export const ID_INVENTORY_TOGGLE = "inventory-toggle";
export const ID_CATEGORY_TOGGLE = "catalog-toggle";
